  ...
  return (
    <div>
      <div className="panel">
        ...
        <div className="note" style={{ marginTop: 12 }}>{t({ en: 'Each letter uses a Caesar shift given by the repeating keyword. The same plaintext letter encrypts differently depending on position - that defeats simple frequency analysis.', de: 'Jeder Buchstabe nutzt eine Caesar-Verschiebung aus dem wiederholten Schlüsselwort. Derselbe Klarbuchstabe wird je nach Position anders verschlüsselt.' })}</div>
      </div>
