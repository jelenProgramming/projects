...
export function buildTrie(words) {
  ...
  snap({}, { en: 'Insert words into a trie. Each letter is an edge; shared prefixes share a path.', de: 'Woerter in einen Trie einfuegen. Jeder Buchstabe ist eine Kante; gemeinsame Praefixe teilen einen Pfad.' })
  ...
  snap({ done: true }, { en: 'Trie built. Looking up any word is O(word length), regardless of how many are stored.', de: 'Trie gebaut. Ein Wort nachzuschlagen ist O(Wortlaenge), egal wie viele gespeichert sind.' })
  return steps
}
