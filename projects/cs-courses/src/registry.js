...
export const ALGORITHMS = [
  ...
  v('selection-sort', 'Selection Sort', 'sorting', 'extra',  { tagline: { en: 'Pick the smallest, repeat', de: 'Das Kleinste waehlen, wiederholen', sl: 'Izberi najmanjšega, ponovi' } }),
  v('insertion-sort', 'Insertion Sort', 'sorting', 'AIPS',   { tagline: { en: 'Reduce-and-conquer sorting', de: 'Sortieren durch Einfuegen', sl: 'Urejanje z vstavljanjem' } }),
  ...
  v('heap-sort',      'Heap Sort',      'sorting', 'AIPS',   { tagline: { en: 'Sort using a binary heap', de: 'Sortieren mit einem Binaerheap', sl: 'Urejanje z binarno kopico' } }),
  v('counting-sort',  'Counting Sort',  'sorting', 'ARA',    { tagline: { en: 'Linear-time counting', de: 'Lineares Zaehlen', sl: 'Štetje v linearnem času' } }),
  v('radix-sort',     'Radix Sort',     'sorting', 'ARA',    { tagline: { en: 'Linear-time: digit by digit', de: 'Lineare Zeit: Ziffer fuer Ziffer', sl: 'Linearni čas: števko za števko' } }),

  v('bfs',            'Breadth-First Search', 'graphs', 'AIPS', { tagline: { en: 'Shortest path in hops', de: 'Kuerzester Weg in Schritten', sl: 'Najkrajša pot po skokih' } }),
  v('dfs',            'Depth-First Search',   'graphs', 'AIPS', { tagline: { en: 'Go as deep as possible first', de: 'Zuerst so tief wie moeglich gehen', sl: 'Najprej čim globlje' } }),
  v('dijkstra',       'Dijkstra',             'graphs', 'AIPS', { tagline: { en: 'Shortest path with dist[] and pred[] arrays', de: 'Kuerzester Weg mit dist[]- und pred[]-Arrays', sl: 'Najkrajša pot s poljema dist[] in pred[]' }, star: true }),
  ...
  v('bst',            'Binary Search Tree', 'trees', 'AIPS', { tagline: { en: 'Insert / search / delete', de: 'Einfuegen / Suchen / Loeschen', sl: 'Vstavljanje / iskanje / brisanje' } }),
  v('binary-heap',    'Binary Heap',        'trees', 'AIPS', { tagline: { en: 'Heapify and priority queue', de: 'Heapify und Prioritaetswarteschlange', sl: 'Kopičenje in prednostna vrsta' } }),
  v('trie',           'Trie (prefix tree)', 'trees', 'ARA',  { tagline: { en: 'Prefix tree for strings', de: 'Praefixbaum fuer Zeichenketten', sl: 'Predponsko drevo za nize' } }),
  ...
  v('n-queens',       'N-Queens',       'backtracking', 'AIPS', { tagline: { en: 'Place queens, backtrack on conflict', de: 'Damen setzen, bei Konflikt zurueckverfolgen', sl: 'Postavi dame, sestopi ob konfliktu' } }),
  v('graph-coloring', 'Graph Coloring', 'backtracking', 'AIPS', { tagline: { en: 'Color nodes so neighbors differ', de: 'Knoten faerben, sodass Nachbarn sich unterscheiden', sl: 'Pobarvaj vozlišča, da se sosedje razlikujejo' } }),
  ...
  v('kmp',            'Knuth-Morris-Pratt','strings', 'ARA', { tagline: { en: 'Prefix function, never backtrack the text', de: 'Praefixfunktion, kein Zurueckspringen im Text', sl: 'Predponska funkcija, brez vračanja po besedilu' } }),
  v('boyer-moore',    'Boyer-Moore',      'strings', 'ARA', { tagline: { en: 'Bad-character jumps', de: 'Spruenge per Bad-Character-Regel', sl: 'Skoki po slabem znaku' } }),
  ...
  r('optimal-bst',    'Optimal BST',      'dp', 'AIPS', { tagline: { en: 'Optimal binary search trees', de: 'Optimale binaere Suchbaeume', sl: 'Optimalna dvojiška iskalna drevesa' } }),
  ...
  v('huffman',        'Huffman Coding',     'compression', 'ARA', { tagline: { en: 'Optimal prefix codes plus tree', de: 'Optimale Praefixcodes plus Baum', sl: 'Optimalne predponske kode z drevesom' }, star: true }),
  v('lzw',            'LZW',                'compression', 'ARA', { tagline: { en: 'Dictionary compression, traced live', de: 'Woerterbuch-Kompression, live nachvollzogen', sl: 'Slovarsko stiskanje, prikazano v živo' }, star: true }),
  r('shannon-fano',   'Shannon-Fano',      'compression', 'ARA', { tagline: { en: 'Top-down prefix coding', de: 'Top-down-Praefixcodierung', sl: 'Predponsko kodiranje od zgoraj navzdol' } }),
  ...
  r('lz77',           'LZ77 / LZ78',       'compression', 'ARA', { tagline: { en: 'Sliding-window dictionary compression', de: 'Woerterbuch-Kompression mit Schiebefenster', sl: 'Slovarsko stiskanje z drsnim oknom' } }),
  ...
  r('basc',           'BASC',                'compression', 'ARA', { tagline: { en: 'Binary adaptive sequential coding of integer runs', de: 'Binaere adaptive sequentielle Codierung von Ganzzahlfolgen', sl: 'Binarno prilagodljivo zaporedno kodiranje nizov celih števil' } }),

  v('caesar',         'Caesar / Shift',   'crypto', 'ARA', { tagline: { en: 'Shift cipher', de: 'Verschiebechiffre', sl: 'Zamična šifra' } }),
  v('vigenere',       'Vigenere',         'crypto', 'ARA', { tagline: { en: 'Keyword cipher', de: 'Schluesselwort-Chiffre', sl: 'Šifra s ključno besedo' } }),
  ...
  r('master-theorem', 'Master Theorem',       'divide', 'core', { tagline: { en: 'Solve divide-and-conquer recurrences', de: 'Rekurrenzen von Teile-und-herrsche loesen', sl: 'Reševanje rekurzij deli in vladaj' } }),
  ...
  v('euclid-gcd',     'Euclidean Algorithm',  'discrete', 'DS', { tagline: { en: 'Greatest common divisor by repeated remainder', de: 'Groesster gemeinsamer Teiler durch wiederholten Rest', sl: 'Največji skupni delitelj s ponavljajočim ostankom' } }),
  ...
  r('crt',            'Chinese Remainder Theorem','discrete', 'DS', { tagline: { en: 'Solve simultaneous congruences', de: 'Simultane Kongruenzen loesen', sl: 'Reševanje sočasnih kongruenc' } }),
  ...
  r('induction',      'Mathematical Induction','discrete', 'DS', { tagline: { en: 'Prove statements for all n', de: 'Aussagen fuer alle n beweisen', sl: 'Dokazovanje trditev za vse n' } }),
  ...
  r('recurrences',    'Recurrence Relations', 'discrete', 'DS', { tagline: { en: 'Solve linear recurrences with the characteristic equation', de: 'Lineare Rekurrenzen mit der charakteristischen Gleichung loesen', sl: 'Reševanje linearnih rekurzij s karakteristično enačbo' } }),
  r('graph-theory',   'Graph Theory Basics',  'discrete', 'DS', { tagline: { en: 'Degree, trees, Euler vs Hamilton', de: 'Grad, Baeume, Euler vs Hamilton', sl: 'Stopnja, drevesa, Euler proti Hamiltonu' } }),

  v('epsilon-delta',  'Epsilon-Delta Limit',  'calculus', 'MA', { tagline: { en: 'See for-all epsilon, exists delta', de: 'Sieh fuer-alle epsilon, existiert delta', sl: 'Poglej: za vsak epsilon obstaja delta' }, star: true }),
  ...
  v('riemann',        'Riemann Sums',         'calculus', 'MA', { tagline: { en: 'Rectangles converging to the area', de: 'Rechtecke, die gegen die Flaeche konvergieren', sl: 'Pravokotniki, ki konvergirajo k ploščini' } }),
  v('taylor',         'Taylor Series',        'calculus', 'MA', { tagline: { en: 'Approximate a curve with a polynomial', de: 'Eine Kurve mit einem Polynom annaehern', sl: 'Približaj krivuljo s polinomom' } }),
  ...
  v('mean-value',     'Rolle & Mean Value Theorem', 'calculus', 'MA', { tagline: { en: 'The cornerstone existence theorems of calculus', de: 'Die zentralen Existenzsaetze der Analysis', sl: 'Temeljni eksistenčni izreki analize' }, star: true }),
  ...
  r('integration-techniques','Integration Techniques', 'calculus', 'MA', { tagline: { en: 'Substitution, by parts, partial fractions', de: 'Substitution, partiell, Partialbrueche', sl: 'Substitucija, per partes, delni ulomki' } }),
  ...
  r('big-o',          'Big-O & Complexity',   'programming', 'core', { tagline: { en: 'How runtime scales with input size', de: 'Wie die Laufzeit mit der Eingabegroesse waechst', sl: 'Kako se čas izvajanja veča z velikostjo vhoda' }, star: true }),
  ...
  r('functions',      'Functions & Parameters','programming', 'P1', { tagline: { en: 'By value vs by reference', de: 'Wert- vs. Referenzuebergabe', sl: 'Po vrednosti proti po referenci' } }),
  v('recursion',      'Recursion',            'programming', 'P1', { tagline: { en: 'Factorial, Fibonacci, Towers of Hanoi', de: 'Fakultaet, Fibonacci, Tuerme von Hanoi', sl: 'Fakulteta, Fibonacci, Hanojski stolpi' } }),
  ...
  r('constructors',        'Constructors & Destructors', 'programming', 'P2', { tagline: { en: 'Object lifecycle: build and clean up', de: 'Objektlebenszyklus: aufbauen und aufraeumen', sl: 'Življenjski cikel objekta: gradnja in čiščenje' } }),
  ...
  r('operator-overloading','Operator Overloading', 'programming', 'P2', { tagline: { en: 'Give + == << meaning for your types', de: 'Gib + == << Bedeutung fuer deine Typen', sl: 'Določi pomen +, ==, << za svoje tipe' } }),
  ...
  r('move-semantics',      'Move Semantics (C++11)', 'programming', 'P2', { tagline: { en: 'Rvalue references, move not copy', de: 'Rvalue-Referenzen, verschieben statt kopieren', sl: 'Reference na R-vrednost, premakni namesto kopiraj' } }),
  ...
  r('keys',           'Keys & ER Model',      'databases', 'PB', { tagline: { en: 'Primary, foreign keys, cardinality', de: 'Primaer-, Fremdschluessel, Kardinalitaet', sl: 'Primarni, tuji ključi, kardinalnost' } }),
  r('normalization',  'Normalization',        'databases', 'PB', { tagline: { en: '1NF to BCNF, functional dependencies', de: '1NF bis BCNF, funktionale Abhaengigkeiten', sl: 'Od 1NF do BCNF, funkcijske odvisnosti' } }),
  ...
  r('transactions',   'Transactions & ACID',  'databases', 'PB', { tagline: { en: 'Atomicity, consistency, isolation, durability', de: 'Atomaritaet, Konsistenz, Isolation, Dauerhaftigkeit', sl: 'Atomarnost, konsistentnost, izolacija, trajnost' } }),
  ...
  v('number-systems', 'Number Systems',       'systems', 'ORS', { tagline: { en: 'Binary, decimal, hex, interactive', de: 'Binaer, Dezimal, Hex, interaktiv', sl: 'Dvojiško, desetiško, šestnajstiško, interaktivno' }, star: true }),
  ...
  r('von-neumann',    'Von Neumann Architecture','systems', 'ORS', { tagline: { en: 'CPU, memory, the fetch-execute cycle', de: 'CPU, Speicher, der Hol-Ausfuehr-Zyklus', sl: 'CPE, pomnilnik, cikel prevzemi-izvedi' } }),
  ...
  r('processes-threads','Processes & Threads','systems', 'core', { tagline: { en: 'Concurrency basics', de: 'Grundlagen der Nebenlaeufigkeit', sl: 'Osnove sočasnosti' } }),
  ...
  v('http',           'HTTP',                 'web', 'OSS', { tagline: { en: 'Methods, status codes, an inspectable request', de: 'Methoden, Statuscodes, eine pruefbare Anfrage', sl: 'Metode, statusne kode, pregledljiva zahteva' } }),
  ...
  v('tcp-ip',         'TCP/IP Handshake',     'web', 'OSS', { tagline: { en: 'The three-way handshake, step by step', de: 'Der Drei-Wege-Handshake, Schritt fuer Schritt', sl: 'Trosmerno rokovanje, korak za korakom' } }),
