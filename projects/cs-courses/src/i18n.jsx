...
const DICT = {
  ...
  runAlgo: { en: 'Run', de: 'Ausführen', sl: 'Zaženi' },
  addNode: { en: 'Add node', de: 'Knoten hinzufügen', sl: 'Dodaj vozlišče' },
  addEdge: { en: 'Add edge', de: 'Kante hinzufügen', sl: 'Dodaj povezavo' },
  deleteMode: { en: 'Delete', de: 'Löschen', sl: 'Izbriši' },
  moveMode: { en: 'Move', de: 'Verschieben', sl: 'Premakni' },
  resetGraph: { en: 'Reset graph', de: 'Graph zurücksetzen', sl: 'Ponastavi graf' },
  editHint: { en: 'Move: drag nodes. Add edge: click two nodes. Delete: click a node or edge. Double-click empty space to add a node.', de: 'Verschieben: Knoten ziehen. Kante: zwei Knoten klicken. Löschen: Knoten oder Kante klicken. Doppelklick auf leere Fläche für neuen Knoten.', sl: 'Premikanje: povlecite vozlišča. Povezava: kliknite dve vozlišči. Brisanje: kliknite vozlišče ali povezavo. Dvakrat kliknite prazno površino za novo vozlišče.' },
